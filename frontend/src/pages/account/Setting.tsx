        ...
        <div className="flex items-start space-x-6">
          <div className="relative">
            ...
            <button
              ...
              className="absolute bottom-0 right-0 w-8 h-8 bg-brand-primary text-white rounded-full hover:bg-brand-primary/90 transition-colors flex items-center justify-center"
            >
